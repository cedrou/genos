...
const CilOpCode cilOpCode_FE[] = 
{
  ...
  { 0x06, NULL, "ldftn",        false, 2, cilTOKEN },
  ...
  { 0x16, NULL, "constrained.", true, 2, cilTOKEN },
...
{
  { 0x00, NULL, "nop",            false, 1, cilNONE },
  { 0x01, NULL, "break",          false, 1 },
  { 0x02, NULL, "ldarg.0",        false, 1, cilNONE },
  ...
  { 0x0E, NULL, "ldarg.s",        false, 1, cilUINT8 },
  { 0x0F, NULL, "ldarga.s",       false, 1, cilUINT8 },
  { 0x10, NULL, "starg.s",        false, 1, cilUINT8 },
  { 0x11, NULL, "ldloc.s",        false, 1, cilUINT8 },
  { 0x12, NULL, "ldloca.s",       false, 1, cilUINT8 },
  { 0x13, NULL, "stloc.s",        false, 1, cilUINT8 },
  ...
  { 0x1F, NULL, "ldc.i4.s",       false, 1, cilUINT8 },
  { 0x20, NULL, "ldc.i4",         false, 1, cilUINT32 },
  { 0x21, NULL, "ldc.i8",         false, 1 },
  { 0x22, NULL, "ldc.r4",         false, 1, cilR4 },
  { 0x23, NULL, "ldc.r8",         false, 1, cilR8 },
  { 0x25, NULL, "dup",            false, 1 },
  { 0x26, NULL, "pop",            false, 1 },
  { 0x27, NULL, "jmp",            false, 1 },
  { 0x28, NULL, "call",           false, 1, cilTOKEN },
  { 0x29, NULL, "calli",          false, 1 },
  { 0x2A, NULL, "ret",            false, 1 },
  { 0x2B, NULL, "br.s",           false, 1, cilOFFSET8 },
  { 0x2C, NULL, "brfalse.s",      false, 1, cilOFFSET8 },
  { 0x2D, NULL, "brtrue.s",       false, 1, cilOFFSET8 },
  { 0x2E, NULL, "beq.s",          false, 1, cilOFFSET8 },
  { 0x2F, NULL, "bge.s",          false, 1, cilOFFSET8 },
  { 0x30, NULL, "bgt.s",          false, 1, cilOFFSET8 },
  { 0x31, NULL, "ble.s",          false, 1, cilOFFSET8 },
  { 0x32, NULL, "blt.s",          false, 1, cilOFFSET8 },
  { 0x33, NULL, "bne.un.s",       false, 1, cilOFFSET8 },
  { 0x34, NULL, "bge.un.s",       false, 1, cilOFFSET8 },
  { 0x35, NULL, "bgt.un.s",       false, 1, cilOFFSET8 },
  { 0x36, NULL, "ble.un.s",       false, 1, cilOFFSET8 },
  { 0x37, NULL, "blt.un.s",       false, 1, cilOFFSET8 },
  { 0x38, NULL, "br",             false, 1, cilOFFSET32 },
  { 0x39, NULL, "brfalse",        false, 1, cilOFFSET32 },
  { 0x3A, NULL, "brtrue",         false, 1, cilOFFSET32 },
  { 0x3B, NULL, "beq",            false, 1, cilOFFSET32 },
  { 0x3C, NULL, "bge",            false, 1, cilOFFSET32 },
  { 0x3D, NULL, "bgt",            false, 1, cilOFFSET32 },
  { 0x3E, NULL, "ble",            false, 1, cilOFFSET32 },
  { 0x3F, NULL, "blt",            false, 1, cilOFFSET32 },
  { 0x40, NULL, "bne.un",         false, 1, cilOFFSET32 },
  { 0x41, NULL, "bge.un",         false, 1, cilOFFSET32 },
  { 0x42, NULL, "bgt.un",         false, 1, cilOFFSET32 },
  { 0x43, NULL, "ble.un",         false, 1, cilOFFSET32 },
  { 0x44, NULL, "blt.un",         false, 1, cilOFFSET32 },
  ...
  { 0x6F, NULL, "callvirt",       false, 1, cilTOKEN },
  { 0x70, NULL, "cpobj",          false, 1 },
  { 0x71, NULL, "ldobj",          false, 1 },
  { 0x72, NULL, "ldstr",          false, 1, cilTOKEN },
  { 0x73, NULL, "newobj",         false, 1, cilTOKEN },
  { 0x74, NULL, "castclass",      false, 1, cilTOKEN },
  ...
  { 0x7B, NULL, "ldfld",          false, 1, cilTOKEN },
  { 0x7C, NULL, "ldflda",         false, 1, cilTOKEN },
  { 0x7D, NULL, "stfld",          false, 1, cilTOKEN },
  { 0x7E, NULL, "ldsfld",         false, 1, cilTOKEN },
  { 0x7F, NULL, "ldsflda",        false, 1, cilTOKEN },
  { 0x80, NULL, "stsfld",         false, 1, cilTOKEN },
  ...
  { 0x8D, NULL, "newarr",         false, 1, cilTOKEN },
